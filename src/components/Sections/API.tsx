...
export function API() {
  return <>
    ...
    <ul>
      <li><InlineCode>withStore</InlineCode>: A <a href='https://reactjs.org/docs/higher-order-components.html' target='_blank' rel="noopener noreferrer">Higher Order React Component</a> (HOC) that's connected to your store. Use it to wrap your own React components to connect them to the store too. The HOC will pass your store into every component you wrap it with as <InlineCode>props.store</InlineCode>. Connected components re-render automatically whenever the store updates.</li>
    ...
    <p><InlineCode>connect</InlineCode> creates a <a href='https://reactjs.org/docs/higher-order-components.html' target='_blank' rel="noopener noreferrer">Higher Order React Component</a> (HOC) that's connected to your store. Use it to wrap your own React components to connect them to the store too. The HOC will pass your store into every component you wrap it with as <InlineCode>props.store</InlineCode>. Connected components re-render automatically whenever the store updates.</p>
    ...
    <p><InlineCode>on</InlineCode> returns a full <a target='_blank' rel="noopener noreferrer" href='http://reactivex.io/rxjs/class/es6/Observable.js~Observable.html'>RxJS Observable</a>, so you have fine control over how you react to a change. Effects have access to around 100 utility functions that are included with RxJS.</p>
