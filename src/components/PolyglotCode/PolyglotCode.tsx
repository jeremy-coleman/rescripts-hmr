...
export function PolyglotCode({
  ...
  if (language in blocks) {
    ...
    let playgroundLink = playgroundLinks && playgroundLinks[language]
      ? <a href={playgroundLinks[language]} target='_blank' rel="noopener noreferrer">playground <ExternalLink /></a>
      : ''
  ...
  return <div className='Code'>
    ...
    {/* TODO: Exact link*/}
    <h4 className='MissingSub'><a href='https://github.com/bcherny/undux.org/tree/master/src/copy'>Submit a Pull Request Please</a></h4>
  </div>
}
